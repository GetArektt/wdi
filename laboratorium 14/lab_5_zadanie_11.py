...
# Petla pozwalajaca odrzucic liczby niedodatnie, poniewaz wtedy najmniejsza wspolna wielokrotnosc nie ma sensu matematycznego
while a <= 0 or b <= 0 or c <= 0:
    print("Liczba musi byc wieksza od 0. Wpisz jeszcze raz 3 liczby:")
    a = int(input())
    b = int(input())
    c = int(input())
